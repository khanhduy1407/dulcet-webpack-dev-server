...
function versionInfo() {
	return `webpack-dev-server ${require("../package.json").version}\n` +
		`@dulcetjs/webpack ${require("@dulcetjs/webpack/package.json").version}`;
}
...
require("@dulcetjs/webpack/bin/config-yargs")(yargs);
...
const wpOpt = require("@dulcetjs/webpack/bin/convert-argv")(yargs, argv, {
...
function broadcastZeroconf(options) {
	...
	bonjour.publish({
		name: "Dulcet Webpack Dev Server",
		port: options.port,
		type: "http",
		subtypes: ["@dulcetjs/webpack"]
	});
